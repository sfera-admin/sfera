...
<head>
    ...
    <style>
        body {
            ...
            color: #3CB4E5; /* Синий цвет текста */
        }
        ...
        #token-info p:last-child {
            margin-bottom: 1em; /* Отступ вниз для последнего параграфа */
        }

        footer a {
            color: #3CB4E5; /* Синий цвет текста ссылок в футере */
        }
